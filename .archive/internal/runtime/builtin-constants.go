...
func registerConstants(scope *Scope) {
	...
	// Angle
	scope.Set("rad", CONST_RAD)
	scope.Set("deg", CONST_DEG)
	scope.Set("grad", CONST_GRAD)
	scope.Set("arcmin", CONST_ARCMIN)
	scope.Set("arcsec", CONST_ARCSEC)
	...
	// Area
	scope.Set("sqmm", CONST_SQMM)
	scope.Set("sqcm", CONST_SQCM)
	scope.Set("sqm", CONST_SQM)
	scope.Set("sqkm", CONST_SQKM)
	scope.Set("sqin", CONST_SQIN)
	scope.Set("sqft", CONST_SQFT)
	scope.Set("sqyd", CONST_SQYD)
	scope.Set("sqmi", CONST_SQMI)
	scope.Set("acre", CONST_ACRE)
	scope.Set("hectare", CONST_HECTARE)
